...
const Show = () => {
  ...
  const userIconSource = post.user.profileImagePath ? { uri: post.user.profileImagePath } : require('../../../../assets/images/icon/default-account.png');
            ...
            <List.Section>
              ...
              <View style={styles.postUser}>
                <View style={styles.postIcon}>
                  <ImageBackground source={require('../../../../assets/images/icon/default-account.png')} resizeMode="cover" style={styles.twitterIcon}>
                    <Image
